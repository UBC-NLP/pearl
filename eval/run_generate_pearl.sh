...
# DATASET_PATH="UBC-NLP/PEARL-LITE-benchmark"
DATASET_PATH="UBC-NLP/PEARL-benchmark"
SPLIT="test"
CACHE_DIR="cache"
BATCH_SIZE=16
...
MODELS[4]="Qwen/Qwen2.5-VL-3B-Instruct|Qwen2.5-VL-3B-Instruct"
MODELS[5]="CohereForAI/aya-vision-8b|aya-vision-8b"
MODELS[6]="Qwen/Qwen2.5-VL-32B-Instruct|Qwen2.5-VL-32B-Instruct"
MODELS[7]="google/gemma-3-12b-it|gemma-3-12b-it"
MODELS[8]="Qwen/Qwen2.5-VL-72B-Instruct|Qwen2.5-VL-72B-Instruct"



# Use XFormers for attention kernels
# export VLLM_ATTENTION_BACKEND=FLASH_ATTN
# Disable Triton FlashAttention (use CK or PyTorch native attention)
...
for model_info in "${MODELS[@]}"; do
        ...
        CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES="0,1,2,4" python generate_pearl.py \
        ...
        if [ $? -eq 0 ]; then
                echo "Evaluation completed successfully for $MODEL_NAME at $(date)"
